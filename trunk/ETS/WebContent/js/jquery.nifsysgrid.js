/**
 * This is custom plugin developed for eHRMS application. This plugin is internally dependant on JQGrid. 
 */
(function($)
{
		
	$.fn.nifsysgrid = function(settings)
	{
	...
	$.fn.popupgrid = function(settings)
	{
		...
		$("#"+gridId).nifsysgrid(popupgridConfig);
		return this;
	};
